...
class ViewImageBeforeUpload extends StatefulWidget {
  ...
  ViewImageBeforeUpload(this._file, this._chatRoomId, this._username);

  @override
  _ViewImageBeforeUploadState createState() =>
      _ViewImageBeforeUploadState(_file, _chatRoomId, _username);
}

class _ViewImageBeforeUploadState extends State<ViewImageBeforeUpload> {
  _ViewImageBeforeUploadState(File file, String chatRoomId, String username);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (location != null) {
            ...
            DataBaseMethods.sendConversationMessage(
                widget._chatRoomId, messageMap);
            String sendToken =
                await DataBaseMethods.getUserToken(Constants.Token);
            print(sendToken);
